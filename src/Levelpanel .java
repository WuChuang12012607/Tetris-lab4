...
class Levelpanel extends JFrame {
    ...
    Levelpanel(){
        ...
        bt2 = new JButton("快速模式");panel.add(bt2);bt2.setBounds(150,180,300,75);
        ...
        ImageIcon imageIcon1 = new ImageIcon("pics/1.png");
        ...
        bt1.addActionListener(e -> {
            ...
            operation.shape=operation.nShape[a2];
        ...
        bt2.addActionListener(e -> {
            ...
            int a2= random.nextInt(21);
            operation2.shape=operation2.aShape[a2];
        ...
        bt3.addActionListener(e -> {
            ...
            int a2= random.nextInt(21);
            operation3.shape=operation3.cShape[a2];
